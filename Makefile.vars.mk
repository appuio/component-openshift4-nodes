...
instance ?= defaults
test_instances = tests/defaults.yml tests/gcp.yml tests/maxpods.yml tests/pidslimit.yml tests/machineconfig.yml tests/remove-machineconfigpool.yml tests/autoscaling.yml tests/capacity.yml tests/node-disruption-policies.yml tests/cloudscale.yml tests/openstack.yml
